    ...
    <div class="main__blog">
        <?php if (have_posts()) : ?>
            <div class="widget" style="margin-bottom:1.5rem">
                <div class="widget__title">
                    ...
                    <?php if (is_category()) : ?>
                        Categoría: <strong style="color:var(--accent)"><?php single_cat_title(); ?></strong>
                    <?php elseif (is_tag()) : ?>
                        Etiqueta: <strong style="color:var(--accent)"><?php single_tag_title(); ?></strong>
                    <?php elseif (is_author()) : ?>
                        Autor: <strong style="color:var(--accent)"><?php the_author(); ?></strong>
                    <?php elseif (is_date()) : ?>
                        Archivo: <strong style="color:var(--accent)"><?php the_archive_title(); ?></strong>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <?php else : ?>
            <div class="article text-center">
                ...
                <p>Prueba con otra búsqueda o vuelve al inicio.</p>
            </div>
        <?php endif; ?>
    </div>
    <?php get_sidebar(); ?>
